 ...
 * @param {boolean} [options.trackResize=true]  If `true` or return `true`, the map will automatically resize when the browser window resizes.
...
class Map extends Camera {
    ...
    ******************************************************************************/
    ...
    _onWindowResize(event: Event) {
        const isTrackResizeFunction = this._trackResize instanceof Function;

        if (
            (isTrackResizeFunction && this._trackResize()) ||
            (!isTrackResizeFunction && this._trackResize)) {
